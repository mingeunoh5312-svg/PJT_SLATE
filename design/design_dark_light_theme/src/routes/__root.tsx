...
import { getInitialThemeScript } from "../components/theme-toggle";
  ...
  head: () => ({
    meta: [
      ...
      { title: "Slate — 영화·영상 제작 협업 플랫폼" },
      {
        name: "description",
        content:
          "Slate는 영화·영상 제작자, 팀, 기업, 운영자를 잇는 제작 협업 플랫폼입니다. 프로필·포트폴리오, 팀 매칭, 작업물, 공모전, AI 로케이션 탐색을 한 곳에서.",
      },
      { name: "author", content: "Slate" },
      { property: "og:title", content: "Slate — 영화·영상 제작 협업 플랫폼" },
      {
        property: "og:description",
        content: "프로필·포트폴리오, 팀 매칭, 공모전, AI 로케이션 탐색을 한 곳에서.",
      },
